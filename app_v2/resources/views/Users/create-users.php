                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="username" id="username" class="form-control" placeholder="Enter username" aria-label="User name">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="" class="pt-3">Contact Number</label>
                                    <input type="text" id="ContactNumber" class="form-control" placeholder="Enter contact number" aria-label="">
                                </div>
                            </div> 
                        </div>
                        <div class="row"> 
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="personalContactEmail" class="form-control" placeholder="Enter personal contact email" aria-label="">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="" class="pt-3">Password</label>
                                    <input type="password" id="password" class="form-control" placeholder="Enter auth password" aria-label="">
                                </div>
                            </div>
                        </div> 
                        <div class="row">
