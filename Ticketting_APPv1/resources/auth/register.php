            ...
            <div style="margin: 0 auto;" class="justify-content-center w-50">
                ...
                <form action="/register" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        <label for="jobRegNumber">Job Registration Number</label>
                        <input type="text" name="jobRegNo" id="jobRegNo" class="form-control" placeholder="Enter Job Number" autofocus autocomplete="on" aria-describedby="helpId" required="required">
                        <small>Must be active!</small>
                    </div>
                    <div class="form-group">
