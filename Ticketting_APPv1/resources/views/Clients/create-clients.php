<div class="create-clients fluid close-route">
    ...
    <div class="create-clients-form">
        <div class="container">
            <form class="create-client-form border border-info rounded clients_registration_form">
                <div class="container"> 
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="firstname" id="firstName" class="form-control firstName" placeholder="Enter first name" aria-label="firstName" required="required">
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group">
                                    <label for="" class="pt-3">Last Name</label>
                                    <input type="text" name="lastname" id="lastName" class="form-control lastName" placeholder="Enter last name" aria-label="lastName" required="required">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="ContactNumber" class="form-control ContactNumber" placeholder="Enter contact number" aria-label="ContactNumber" required="required">
                                </div>
                            </div> 
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="" class="pt-3">Personal Contact Email</label>
                                    <input type="text" id="personalContactEmail" class="form-control personalContactEmail" placeholder="Enter personal contact email" aria-label="personalContactEmail" required="required">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="organizationName" class="form-control organizationName" placeholder="Enter organization name" aria-label="organizationName">
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group">
                                    <label for="" class="pt-3">Organization Contact Email <small>(If applicable)</small></label>
                                    <input type="text" id="organizationContactEmail" class="form-control organizationContactEmail" placeholder="Enter organization contact email" aria-label="organizationContactEmail">
                                </div>
                            </div>
                        </div>
                        <div class="row">
